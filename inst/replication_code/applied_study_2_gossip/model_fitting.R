...
WAVE=4
NUM_CORE = 36
class_begin = 2 #doing it in chuncks
class_end = 9

filtered_df <- read.csv(paste0(path_to_package, "data-raw/gossip/filtered_df_no_missing_wave_4.csv")) #change to your own 
class_ids <- filtered_df$class_id[class_begin:class_end]
...
cl <- parallel::makeCluster(NUM_CORE, outfile="")  
