...
#'
#' @param model.obj a Mp2Model object
...
#' @return NULL
#' @export
convergence_check <- function(model.obj, params, custom_params="", plot=c("traceplot", "running", "geweke", "density"), plot_all = FALSE, file = "ggmcmc-output.pdf") {
    fit <- model.obj$fit_res$stan_fit
    par_labels <- model.obj$fit_res$par_labels
